...
/** Task:1 **/ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _sumJs = require("./sum.js");
/** Task:2 **/ var _personJs = require("./person.js");
/** Task:3 **/ var _loggerJs = require("./logger.js");
/** Task:4 **/ var _arraylogJs = require("./arraylog.js");
var _arraylogJsDefault = parcelHelpers.interopDefault(_arraylogJs);
/** Task:5 **/ var _userJs = require("./user.js");
var _userJsDefault = parcelHelpers.interopDefault(_userJs);
/** Task:6 **/ var _lodash = require("lodash");
var _lodashDefault = parcelHelpers.interopDefault(_lodash);
/** Task:7 **/ var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
console.log(`Sum of 3 & 4: ${(0, _sumJs.sum)(3, 4)}`);
console.log((0, _personJs.person));
(0, _personJs.person).intro();
(0, _loggerJs.dbLog)();
(0, _loggerJs.controllerLog)(()=>{
    console.log("controller is passed");
});
(0, _loggerJs.apiLog)("https://api.freeapi.app/api/v1/public/stocks");
(0, _arraylogJsDefault.default)([
    1,
    {
        id: 1,
        name: "John"
...
console.log((0, _userJsDefault.default).demoUser);
console.log((0, _userJsDefault.default).userHobbies);
console.log((0, _userJsDefault.default).isUserIsAbove18);
(0, _userJsDefault.default).intro((0, _userJsDefault.default).demoUser);
const url = "https://api.freeapi.app/api/v1/public/randomusers/user/random";
(0, _userJsDefault.default).getUserFromApi(url);
const arr1 = [
    5,
    604,
    75
...
const finalArray = (0, _lodashDefault.default).concat(arr1, arr2, 55);
console.log(finalArray);
(0, _lodashDefault.default).forEach(finalArray, function(value) {
    console.log(value * value);
});
(0, _lodashDefault.default).delay((value)=>console.log(value), 2000, "Later");
const freeapiBookUrl = "https://api.freeapi.app/api/v1/public/books/book/random";
(0, _axiosDefault.default)(freeapiBookUrl).then((response)=>{
    console.log(response.data);
}).catch((error)=>console.log(error));
const kitchenSinkPostUrl = "https://api.freeapi.app/api/v1/kitchen-sink/http-methods/post";
...
},{"./sum.js":"k4fPu","./person.js":"a59fj","./logger.js":"1JZpk","./arraylog.js":"eEF2P","./user.js":"ipSla","lodash":"3qBDj","axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"k4fPu":[function(require,module,exports) {
...
},{}],"a59fj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1JZpk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "dbLog", ()=>dbLog);
parcelHelpers.export(exports, "controllerLog", ()=>controllerLog);
parcelHelpers.export(exports, "apiLog", ()=>apiLog);
const dbLog = ()=>{
    console.log(`Db Connnected : ${new Date()}`);
};
const controllerLog = (controller)=>{
    console.log(`Controls called sucessfull method is ${controller} ${new Date()}`);
    controller();
};
const apiLog = async (url)=>{
    setTimeout(()=>{
        console.log(`Data fetched sucessfully ${new Date()}`);
    }, 2000);
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eEF2P":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ipSla":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const demoUser = {
    id: 5,
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["km5uZ","bB7Pu"], "bB7Pu", "parcelRequirecf69")
